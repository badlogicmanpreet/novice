...
public class PlaceRequest {
	...
	public PlacesList performSearch(double latitude, double longitude) throws Exception {
		try {
			...
			//reqUrl.put("types", "store|clothing_store|convenience_store|department_store|electronics_store|furniture_store|grocery_or_supermarket|hardware_store|home_goods_store|shopping_mall");
